...
If you discover a security vulnerability in the DSP specification, schemas, or reference implementation, please report it responsibly.
...
- The DSP specification (`spec/`)
- JSON Schemas (`schemas/`)
- OpenAPI definition (`spec/dsp-api-v0.1.yaml`)
