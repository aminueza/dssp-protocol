# Contributing to DSSP

Thank you for your interest in the Document Sovereignty Protocol & Privacy.

## Before You Start

1. Read the [specification](spec/dssp-v0.1.md) to understand what DSSP does.
...
Changes to the protocol specification (`spec/`), JSON schemas (`schemas/`), or OpenAPI definition (`spec/dssp-api-v0.1.yaml`) follow the RFC process described in [GOVERNANCE.md](GOVERNANCE.md).
