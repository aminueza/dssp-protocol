...
import pytest
from dssp_sidecar.monitor import MonitorEvidence, NetworkConnection
from dssp_sidecar.verifier import SidecarVerifier
...
class TestNetworkVerification:
    ...
    def test_undeclared_destination_fails(self, verifier):
        ...
        assert any(
            m["type"] == "network_destination_undeclared" for m in result.mismatches
        )
