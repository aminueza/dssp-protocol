...
enclave alongside a DSSP agent. It monitors the agent's actual behavior and
...
```bash
docker build -t dssp-sidecar .
docker run --pid=host dssp-sidecar \
