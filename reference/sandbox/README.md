# DSP Sandbox — Docker Compose Demo

A complete, runnable demo of the Document Sovereignty Protocol.
...
Then visit:
- **Gateway API**: http://localhost:8080/v0.1/.well-known/dsp-configuration
...
2. **minio-setup** creates the `dsp-documents` bucket and uploads sample PDFs
3. **Gateway** starts the DSP API server connected to MinIO
