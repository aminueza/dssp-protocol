...
// for the DSP gateway. Production deployments should implement the Store
...
// EventListOptions controls filtering for audit event queries.
...
// ContractUpdate holds fields that can be updated on a contract.
...
// SessionUpdate holds fields that can be updated on a session.
...
// Store defines the persistence interface for DSP gateway resources.
...
// It is suitable for development, testing, and the reference implementation.
type MemoryStore struct {
	...
	// Insertion-ordered keys for deterministic listing.
